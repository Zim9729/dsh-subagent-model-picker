...
The package targets the DSH `0.1.1-rc.2` service contracts and Node.js 20+. Run `npm run check` before publishing. Publish the package to npm, then submit the repository/package metadata to the DSH plugin center. npm publication and plugin-center catalog approval are separate steps.
